...
resource "aws_cloudfront_distribution" "domain_distribution" {
    ...
    origin {
        domain_name = replace(var.api_invoke_url,"/(https://)|(/api)/","")
        origin_id = "API-V1-${var.domain_name}"
    ...
    default_root_object = var.html_index
    ...
    default_cache_behavior {
        ...
        target_origin_id = "S3-${var.domain_bucket_id}"
    ...
    ordered_cache_behavior {
        ...
        allowed_methods  = ["GET", "HEAD"]
        cached_methods   = ["GET", "HEAD"]
        target_origin_id = "API-V1-${var.domain_name}"
